   ...
   Mass =[] #mass of the ring
    ...
    with open ('histdata.csv', 'r') as f:
        for row in f:
            ...
            Mass.append(float(values[1])) #saves the value of masses in empty list 
\end{verbatim}

\subsection{Optimization of Velocity and Mass}
The rotation curve obtained from the data, that was calculated using Image Analysis as explained in section 2.2.2
